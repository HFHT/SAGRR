...
if (isset($_GET['x'])) {
	...
	if ($stmt = $mysqli->query($prep_stmt)) {
		$row = myFetch($stmt);
		$applSec = json_decode($row[0]['ApplSec2'] == "" ? '{"Ans16":"","Ans17":"","Ans18":"","Ans19":"","Ans20":"","Ans21":"","Ans22":""}' : $row[0]['ApplSec2']);
		$applSec0 = json_decode($row[0]['ApplSec0'] == "" ? '{"MemName":[""],"MemAge":[""],"PetType":["0"],"PetSex":["0"],"PetAge":["0"],"PetHome":["0"],"Ans2":"","Ans3":"","Ans4":"","Ans5":""}' : $row[0]['ApplSec0']);
		...
		<div data-role="main" class="ui-content my-narrow">
			<form id="adoptS2Form" class="forms">
				<ul data-role="listview" data-autodividers="false" data-filter="false">
					<li data-role="list-divider" role="heading" style="font-size:initial;">
						<h3><?php echo $applProgress[2]->{'Sec'} ?></h3>
					</li>
					<li>
						<table style="table-layout:fixed;width:100%;">
							<tbody>
								<tr style="display:none;">
									<td style="padding-bottom:0;white-space:pre-line;" width="70%">Have you owned dogs before?
										<div class="AnsErr16"></div>
									</td>
									<td style="padding-bottom:0;" width="30%">
								...
								<tr class="Ans16Hide" <?php hide($applSec->{'Ans16'} == 'N'); ?>>
									<td style="padding-top:0;padding-bottom:0;white-space:pre-line;">Have you previously owned a Golden?
							...
							<tbody>
								<tr>
									<td colspan="2" style="padding-bottom:0;">
										<p style="font-size:1em;white-space:pre-line;">If you currently have pets, or have owned a pet before, may we contact your veterinarian?</p>
									</td>
								</tr>
								<tr>
									<td colspan="2" style="padding-bottom:0;">
								...
								<tr class="Ans20Hide" <?php hide($applSec->{'Ans20'} == 'N'); ?>>
									<td style="padding-top:0;padding-bottom:0;">Name:
									</td>
									<td style="padding-top:0;padding-bottom:0;">
								...
								<tr class="Ans20Hide" <?php hide($applSec->{'Ans20'} == 'N'); ?>>
									<td style="padding-top:0;padding-bottom:0;">Phone:
									</td>
									<td style="padding-top:0;padding-bottom:0;">
			...
			<form id="adoptS02Form" class="forms">
				<ul data-role="listview" data-autodividers="false" data-filter="false">
					...
					<?php if ($x > 0 and $applSec0->{'MemName'}[$x] == '') {
							break;
						}
					} ?>
					<li>
