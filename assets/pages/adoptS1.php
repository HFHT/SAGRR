...
<div data-role="page" id="adoptS1" data-dom-cache="false">
	...
	<div data-role="main" class="ui-content my-narrow">
		<form id="adoptS1Form" class="forms">
			...
			<li data-role="list-divider" role="heading" style="font-size:initial;"><h3><?php echo $applProgress[1]-> {'Sec'} ?></h3></li>						
			<li>
			...
			<li>
				<table width="100%"><tbody>
					<tr><td style="padding-bottom:0;" width="50%" wrap>Do you have a dog door?
						<div class="AnsErr9"></div>																				
					</td><td style="padding-bottom:0;" width="50%">
					...
					<tr><td style="padding-top:0;padding-bottom:0;"wrap>Is your yard fenced?
					...
					<tr class="Ans12Hide" <?php hide($applSec->{'Ans12'}=='N');?>><td colspan="2" style="padding-left:1.5em; padding-top:0;padding-bottom:0;">
					...
					<tr class="Ans12Hide" <?php hide($applSec->{'Ans12'}=='N');?>><td style="padding-left:1.5em; padding-top:0;padding-bottom:0;" wrap>Height of fence:
						<div class="AnsErr14"></div>																									
					</td><td style="padding-top:0;padding-bottom:0;" class="Ans12Zero">
			...
			<li>
				<table width="100%"><tbody>						
					<tr><td style="padding-top:0;padding-bottom:0;" wrap>Do you own a swimming pool?	
					...
					<tr class="Ans10Hide" <?php hide($applSec->{'Ans10'}=='N');?>><td style="padding-left:1.5em; padding-top:0;padding-bottom:0;" wrap>Is swimming pool fenced?	
					...
					<tr><td style="padding-top:0;padding-bottom:0;" wrap>Do you own a spa?	
					...
					<tr class="Ans110Hide" <?php hide($applSec->{'Ans110'}=='N' or $applSec->{'Ans110'}=='');?>><td style="padding-left:1.5em; padding-top:0;padding-bottom:0;" wrap>Is spa fenced or covered?	
