...
if (isset($_GET['x'])) {
	...
	if ($stmt = $mysqli->query($prep_stmt)) {
		$row = myFetch($stmt);
		$applSec = json_decode($row[0]['ApplSec0']);
...
<div data-role="page" id="adoptS0" data-dom-cache="false">
	...
	<div data-role="main" class="ui-content my-narrow">
		<form id="adoptS0Form" class="forms">
			...
			<li data-role="list-divider" role="heading" style="font-size:initial;"><h3><?php echo $applProgress[0]-> {'Sec'} ?></h3></li>						
			<li>
				...
				<?php 
				for ($x=0; $x<9; $x++) {
					if ($x>2) {$display=$applSec->{'MemName'}[$x]==''?'style="display:none"':$display='';}				
				?>
					<div class="htmlPeople"<?php echo $display;?>>
					<div class="ui-block-a" style="width:70%"><div class="ui-bar ui-bar-a">
					...
					<div class="ui-block-b" style="width:30%"><div class="ui-bar ui-bar-a">
				...
				<div class="ui-grid-solo" id="addPerson">
					<div class="ui-block-a" style="width:100%"><div class="ui-bar ui-bar-a"><input type="button" value="Click to Add Person" class="addPerson" data-mini="true"></div></div>
				</div>
			</li>
			<li>
